...
COUNTRY_INFO = {
    ...
    "RU": {"name": "Russia", "lang": "Russian",
           "competitors": "Лукойл, Газпромнефть G-Energy, Роснефть, Татнефть, Castrol Russia, Shell Helix Russia",
           "note": "Use Russian Cyrillic keywords for brand names. Include 'Россия' or 'Russian' in every query. Avoid generic lubricant terms without Russia context."},
